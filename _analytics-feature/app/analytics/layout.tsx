        ...
        <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
            ...
            <div className="hidden md:flex fixed left-0 top-0 w-64 h-screen bg-card border-r border-border pb-6 pr-6 pl-6 flex-col">
                ...
                <nav className="flex-1 space-y-1">
                    ...
                    <Link href="/dashboard/create-post" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-muted transition-colors text-muted-foreground bg-gradient-to-r from-pink-500/10 to-purple-500/10 border border-pink-500/20">
                        <Instagram className="w-5 h-5 text-pink-500" />
                        <span>Create Post</span>
                    </Link>
                    <Link href="/dashboard/instagram" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-muted transition-colors text-muted-foreground">
                        <ChartBar className="w-5 h-5 text-pink-400" />
                        <span>Posts & Comments</span>
                    </Link>
                    <Link href="/dashboard/settings/connect-accounts" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-muted transition-colors text-muted-foreground">
            ...
            <main className="md:ml-64 md:w-[calc(100%-16rem)] w-full pt-16 md:pt-20">
                {children}
            </main>
        </div>
    )
